    ...
    function updCategory() {
        return function () {
            ...
            if (name == "" || id == "") {
                ...
                if (aux !== -1) {
                    var productions = videosystem.getProductionsCategory(aux);
                    var production = productions.next();
                    var arrProductions = [];
                    ...
                    updDB("category", "categories", aux.name, arrProductions);
                    delDB("categories", aux.name);
                    aux.name = name;
                    if (description != "") {
        ...
        return function () {
            ...
            if (name == "" || lastname == "" || born == "") {
                ...
                for (var x = 0; x < long; x++) {
                    ...
                    var productions = videosystem.getProductionsActor(act);
                    var production = productions.next();
                    var arrProductions = [];
                ...
                addDB(act, "actors", act.name + " " + act.lastname, arrProductions);
                //
                resultForm(true);
            }
    ...
    function updActor() {
        return function () {
            ...
            if (name == "" || lastname == "" || born == "") {
                ...
                if (aux !== -1) {
                    var productions = videosystem.getProductionsActor(aux);
                    var production = productions.next();
                    var arrProductions = [];
                    ...
                    console.log(arrProductions);
                    updDB("actor", "actors", aux.name + " " + aux.lastname, arrProductions);
                    delDB("actors", aux.name + " " + aux.lastname);
                    aux.name = name;
        ...
        return function () {
            ...
            if (name == "" || lastname == "" || born == "") {
                ...
                for (var x = 0; x < long; x++) {
                    ...
                    var productions = videosystem.getProductionsDirector(dir);
                    var production = productions.next();
                    var arrProductions = [];
                ...
                addDB(dir, "directors", dir.name + " " + dir.lastname, arrProductions);
                //
                resultForm(true);
            }
    ...
    function updDirector() {
        return function () {
            ...
            if (name == "" || lastname == "" || born == "") {
                ...
                if (aux !== -1) {
                    var productions = videosystem.getProductionsDirector(aux);
                    var production = productions.next();
                    var arrProductions = [];
                    ...
                    updDB("director", "directors", aux.name + " " + aux.lastname, arrProductions);
                    delDB("directors", aux.name + " " + aux.lastname);
                    aux.name = name;
                    aux.lastname = lastname;
                    aux.born = born;
                    resultForm(true);
...
function sesion() {
    return function () {
        ...
        if (user === "prueba" && pass === "prueba") {
            ...
            window.location.href = 'http://localhost/xampp/IndexedDB';
        } else {
            p.setAttribute("style", "color:red");
